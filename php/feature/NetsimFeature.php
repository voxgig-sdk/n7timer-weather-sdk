...
// N7timerWeather SDK netsim feature
...
class N7timerWeatherNetsimFeature extends N7timerWeatherBaseFeature
{
    ...
    private function _simulate(N7timerWeatherContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(N7timerWeatherContext $ctx, array $applied): void
    {
        $client = $this->client;
