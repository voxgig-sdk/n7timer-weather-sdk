...
// N7timerWeather SDK proxy feature
...
class N7timerWeatherProxyFeature extends N7timerWeatherBaseFeature
{
    ...
    public function init(N7timerWeatherContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (N7timerWeatherContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
