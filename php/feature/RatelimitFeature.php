...
// N7timerWeather SDK ratelimit feature
...
class N7timerWeatherRatelimitFeature extends N7timerWeatherBaseFeature
{
    ...
    private function _acquire(N7timerWeatherContext $ctx): void
    {
    ...
    private function _track(N7timerWeatherContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
