...
// N7timerWeather SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class N7timerWeatherTestFeature extends N7timerWeatherBaseFeature
{
    ...
    public function init(N7timerWeatherContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (N7timerWeatherContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = N7timerWeatherParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (N7timerWeatherContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(N7timerWeatherContext $ctx, $op, $args): array
    {
        ...
        foreach ($keys as $k) {
            ...
            if ($is_id || $in_reqd) {
                $v = N7timerWeatherParam::call($ctx, $k);
