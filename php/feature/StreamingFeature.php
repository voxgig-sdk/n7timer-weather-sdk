...
// N7timerWeather SDK streaming feature
...
class N7timerWeatherStreamingFeature extends N7timerWeatherBaseFeature
{
    ...
    private function _iterate(N7timerWeatherResult $result): \Generator
    {
    ...
    private function _streamable(N7timerWeatherContext $ctx): bool
    {
