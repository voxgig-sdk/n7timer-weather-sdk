...
// N7timerWeather SDK timeout feature
...
class N7timerWeatherTimeoutFeature extends N7timerWeatherBaseFeature
{
    ...
    private function _with_timeout(N7timerWeatherContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(N7timerWeatherContext $_ctx, float $ms): void
    {
        $client = $this->client;
