...
// N7timerWeather SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class N7timerWeatherTransformResponse
{
    public static function call(N7timerWeatherContext $ctx): mixed
    {
        ...
        $transform = N7timerWeatherHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
