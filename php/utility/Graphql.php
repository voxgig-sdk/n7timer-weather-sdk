...
// N7timerWeather SDK utility: graphql
//
...
class N7timerWeatherGraphql
{
    ...
    // equivalent.
    public static function body(N7timerWeatherContext $ctx): mixed
    {
    ...
    public static function errors(N7timerWeatherContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
