...
// N7timerWeather SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class N7timerWeatherMakeRequest
{
    public static function call(N7timerWeatherContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new N7timerWeatherResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new N7timerWeatherResponse($fetched);
        } else {
