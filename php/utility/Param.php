...
// N7timerWeather SDK utility: param

require_once __DIR__ . '/../core/Helpers.php';

class N7timerWeatherParam
{
    public static function call(N7timerWeatherContext $ctx, mixed $paramdef): mixed
    {
        $point = $ctx->point;
        $spec = $ctx->spec;
        $match_val = $ctx->match;
        ...
        $akey = '';
        if ($point) {
            $alias_map = N7timerWeatherHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'alias'));
            if ($alias_map) {
