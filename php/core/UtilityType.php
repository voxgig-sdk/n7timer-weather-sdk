...
// N7timerWeather SDK utility type

class N7timerWeatherUtility
{
    ...
    public static function copy(N7timerWeatherUtility $src): N7timerWeatherUtility
    {
        $u = new N7timerWeatherUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
