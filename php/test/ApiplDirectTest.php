...
class ApiplDirectTest extends TestCase
{
    public function test_direct_list_apipl(): void
    {
        $setup = apipl_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-apipl", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
