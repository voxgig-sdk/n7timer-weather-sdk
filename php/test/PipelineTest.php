...
// N7timerWeather SDK pipeline test
//
...
{
    private static function utility(): N7timerWeatherUtility
    {
        return new N7timerWeatherUtility();
    }
    ...
    private static function ctx(array $over = []): N7timerWeatherContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new N7timerWeatherContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new N7timerWeatherOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof N7timerWeatherError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new N7timerWeatherOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = N7timerWeatherMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new N7timerWeatherOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = N7timerWeatherMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new N7timerWeatherOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = N7timerWeatherMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new N7timerWeatherSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = N7timerWeatherMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new N7timerWeatherResponse([]),
            'result' => new N7timerWeatherResult([]),
        ]);
        [, $err] = N7timerWeatherMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new N7timerWeatherSpec([]),
            'response' => null,
            'result' => new N7timerWeatherResult([]),
        ]);
        [, $err] = N7timerWeatherMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new N7timerWeatherSpec(['step' => 's']),
            'response' => new N7timerWeatherResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new N7timerWeatherResult([]),
        ]);
        [, $err] = N7timerWeatherMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new N7timerWeatherSpec(['step' => 's']),
            'response' => new N7timerWeatherResponse(self::resp(200, ['v' => 1])),
            'result' => new N7timerWeatherResult([]),
        ]);
        [, $err] = N7timerWeatherMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new N7timerWeatherSpec(['step' => 's']),
            'response' => new N7timerWeatherResponse(self::resp(200, ['v' => 2])),
            'result' => new N7timerWeatherResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        N7timerWeatherMakeResponse::call($ctx);
    ...
    {
        $preset = new N7timerWeatherResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new N7timerWeatherSpec([]),
            'response' => new N7timerWeatherResponse([]),
            'result' => new N7timerWeatherResult([]),
        ...
        [$got, $err] = N7timerWeatherMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new N7timerWeatherResult([])]);
        [, $err] = N7timerWeatherMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new N7timerWeatherSpec([]), 'result' => null]);
        [, $err] = N7timerWeatherMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new N7timerWeatherSpec(['step' => 's']),
            'result' => new N7timerWeatherResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new N7timerWeatherOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = N7timerWeatherMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new N7timerWeatherSpec(['step' => 's']),
            'result' => new N7timerWeatherResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new N7timerWeatherOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = N7timerWeatherMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new N7timerWeatherResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new N7timerWeatherSpec([]),
            'result' => new N7timerWeatherResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = N7timerWeatherMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = N7timerWeatherMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new N7timerWeatherError('boom', 'boom');
        $utility->fetcher = function (N7timerWeatherContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new N7timerWeatherSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = N7timerWeatherMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (N7timerWeatherContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = N7timerWeatherMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(N7timerWeatherResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        N7timerWeatherMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (N7timerWeatherContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new N7timerWeatherSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = N7timerWeatherMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new N7timerWeatherResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new N7timerWeatherSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = N7timerWeatherMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = N7timerWeatherMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = N7timerWeatherMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new N7timerWeatherResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, N7timerWeatherDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new N7timerWeatherResult(['ok' => false])]);
        $this->expectException(N7timerWeatherError::class);
        N7timerWeatherDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new N7timerWeatherResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', N7timerWeatherMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        N7timerWeatherMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new N7timerWeatherBaseFeature();
        $b = new N7timerWeatherBaseFeature();
        N7timerWeatherFeatureAdd::call($ctx, $a);
        N7timerWeatherFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): N7timerWeatherBaseFeature
    {
        $f = new N7timerWeatherBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        N7timerWeatherFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): N7timerWeatherContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new N7timerWeatherSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = N7timerWeatherPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        N7timerWeatherPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new N7timerWeatherResponse(['headers' => null]),
            'result' => new N7timerWeatherResult([]),
        ]);
        N7timerWeatherResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        N7timerWeatherResultBody::call($ctx);
