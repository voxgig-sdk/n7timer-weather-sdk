...
// N7timerWeather SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (N7timerWeatherSDK::test)
...
{
    private const SDK_CLASS = 'N7timerWeatherSDK';
    ...
    private const SDK_BASE = 'n7timerweather_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../n7timerweather_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
