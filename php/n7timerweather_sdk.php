...
class N7timerWeatherSDK
{
    ...
    public function __construct(array $options = [])
    {
        ...
        $feature_opts = N7timerWeatherHelpers::to_map(Struct::getprop($this->options, "feature"));
        if ($feature_opts) {
            $featureorder = Struct::getpath($this->options, "__derived__.featureorder");
            if (is_array($featureorder)) {
                foreach ($featureorder as $fname) {
                    $fopts = N7timerWeatherHelpers::to_map($feature_opts[$fname] ?? null);
                    if ($fopts && isset($fopts["active"]) && $fopts["active"] === true) {
                        ...
                        if (!N7timerWeatherFeatures::has_feature($fname)) {
                        ...
                        ($utility->feature_add)($this->_rootctx, N7timerWeatherFeatures::make_feature($fname));
                    }
                }
            }
        }
    ...
    {
        return N7timerWeatherUtility::copy($this->_utility);
    }
    ...
    public function prepare(array $fetchargs = []): mixed
    {
        ...
        $ctrl = N7timerWeatherHelpers::to_map(Struct::getprop($fetchargs, "ctrl")) ?? [];
        ...
        $params = N7timerWeatherHelpers::to_map(Struct::getprop($fetchargs, "params")) ?? [];
        $query = N7timerWeatherHelpers::to_map(Struct::getprop($fetchargs, "query")) ?? [];
    ...
    private function op_denied(string $op): array
    {
        ...
        return [
            "ok" => false,
            "err" => new N7timerWeatherError($op . "_allow",
                "N7timerWeatherSDK: " . $op . ": operation not allowed by" .
    ...
    private function raw_request(array $fetchargs = []): mixed
    {
        ...
        if (is_array($fetched)) {
            $status = N7timerWeatherHelpers::to_int(Struct::getprop($fetched, "status"));
    ...
    public function graphql(string $query, ?array $variables = null, ?array $ctrl = null): mixed
    {
        ...
        if (is_array($errors) && 0 < count($errors)) {
            ...
            $res["ok"] = false;
            $res["err"] = new N7timerWeatherError("graphql_error",
                "N7timerWeatherSDK: graphql: " . $msg);
            $res["graphql"] = $errors;
        }
    ...
    public function Apipl($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_apipl === null) {
                $this->_apipl = new ApiplEntity($this, null);
            }
            return $this->_apipl;
        }
        return new ApiplEntity($this, $data);
    }
    ...
    public function GraphicalApi($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_graphical_api === null) {
                $this->_graphical_api = new GraphicalApiEntity($this, null);
            }
            return $this->_graphical_api;
        }
        return new GraphicalApiEntity($this, $data);
    }
    ...
    public static function test(?array $testopts = null, ?array $sdkopts = null): self
    {
        ...
        $sdk = new N7timerWeatherSDK($sdkopts);
        $sdk->mode = "test";
        return $sdk;
    }
}
