# N7timerWeather TypeScript SDK



The TypeScript SDK for the N7timerWeather API — a type-safe, entity-oriented client with full async/await support.

The API is exposed as capitalised, semantic **Entities** — e.g.
`client.Apipl()` — each with a small set of operations (`list`, `load`)
...
| `tester(testopts?, sdkopts?)` | `N7timerWeatherSDK` | Create a test-mode client instance. |

#### Static methods

| Method | Returns | Description |
| --- | --- | --- |
| `N7timerWeatherSDK.test(testopts?, sdkopts?)` | `N7timerWeatherSDK` | Create a test-mode client. |
...
| `client` | `client(): N7timerWeatherSDK` | Return the parent SDK client. |
...
n7timer-weather/
├── src/
│   ├── N7timerWeatherSDK.ts        # Main SDK class
