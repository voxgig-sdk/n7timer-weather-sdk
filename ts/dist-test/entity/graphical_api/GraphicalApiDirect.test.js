...
(0, node_test_1.describe)('GraphicalApiDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.N7timerWeatherSDK({
    ...
    (0, node_test_1.test)('direct-load-graphical_api', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-graphical_api', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.N7TIMER_WEATHER_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.N7timerWeatherSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['N7TIMER_WEATHER_TEST_GRAPHICAL_API_ENTID'];
    ...
    const client = new __1.N7timerWeatherSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=GraphicalApiDirect.test.js.map