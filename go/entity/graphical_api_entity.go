...
type GraphicalApiEntity struct {
	name    string
	client  *core.N7timerWeatherSDK
...
func NewGraphicalApiEntity(client *core.N7timerWeatherSDK, entopts map[string]any) *GraphicalApiEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *GraphicalApiEntity) GetName() string { return e.name }
...
func (e *GraphicalApiEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *GraphicalApiEntity) Deleted() bool {
	return e.deleted
}


func (e *GraphicalApiEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewGraphicalApiEntity(e.client, opts)
}

func (e *GraphicalApiEntity) Data(args ...any) any {
...
func (e *GraphicalApiEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an GraphicalApi; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *GraphicalApiEntity) DataTyped(data ...GraphicalApi) GraphicalApi {
	if len(data) > 0 {
		return typedFrom[GraphicalApi](e.Data(asMap(data[0])))
	}
	return typedFrom[GraphicalApi](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through GraphicalApi (all fields
// optional at the wire level).
func (e *GraphicalApiEntity) MatchTyped(match ...GraphicalApi) GraphicalApi {
	if len(match) > 0 {
		return typedFrom[GraphicalApi](e.Match(asMap(match[0])))
	}
	return typedFrom[GraphicalApi](e.Match())
}
...
func (e *GraphicalApiEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *GraphicalApiEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// GraphicalApiLoadMatch and returns an GraphicalApi. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *GraphicalApiEntity) LoadTyped(reqmatch GraphicalApiLoadMatch, ctrl map[string]any) (GraphicalApi, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return GraphicalApi{}, err
	}
	return typedFrom[GraphicalApi](res), nil
}



func (e *GraphicalApiEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *GraphicalApiEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *GraphicalApiEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *GraphicalApiEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *GraphicalApiEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
