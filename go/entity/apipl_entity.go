...
func NewApiplEntity(client *core.N7timerWeatherSDK, entopts map[string]any) *ApiplEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ApiplEntity) GetName() string { return e.name }
...
func (e *ApiplEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ApiplEntity) Deleted() bool {
	return e.deleted
}


func (e *ApiplEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewApiplEntity(e.client, opts)
}

func (e *ApiplEntity) Data(args ...any) any {
...
func (e *ApiplEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Apipl; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ApiplEntity) DataTyped(data ...Apipl) Apipl {
	if len(data) > 0 {
		return typedFrom[Apipl](e.Data(asMap(data[0])))
	}
	return typedFrom[Apipl](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Apipl (all fields
// optional at the wire level).
func (e *ApiplEntity) MatchTyped(match ...Apipl) Apipl {
	if len(match) > 0 {
		return typedFrom[Apipl](e.Match(asMap(match[0])))
	}
	return typedFrom[Apipl](e.Match())
}
...
func (e *ApiplEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ApiplEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *ApiplEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ApiplListMatch and returns []Apipl. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *ApiplEntity) ListTyped(reqmatch ApiplListMatch, ctrl map[string]any) ([]Apipl, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Apipl](res), nil
}



func (e *ApiplEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ApiplEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ApiplEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ApiplEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
