...
const testSeed = `map[string]any{"entity": map[string]any{"apipl": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "graphical_api": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
