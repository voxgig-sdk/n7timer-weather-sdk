...
func (sdk *N7timerWeatherSDK) OptionsMap() map[string]any {
...
func (sdk *N7timerWeatherSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *N7timerWeatherSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *N7timerWeatherSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *N7timerWeatherSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *N7timerWeatherSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *N7timerWeatherSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("N7timerWeatherSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *N7timerWeatherSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *N7timerWeatherSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("N7timerWeatherSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *N7timerWeatherSDK {
	...
	sdk := NewN7timerWeatherSDK(sdkopts)
	sdk.Mode = "test"
