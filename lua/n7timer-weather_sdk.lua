...
local N7timerWeatherSDK = {}
N7timerWeatherSDK.__index = N7timerWeatherSDK
...
N7timerWeatherSDK._make_feature = _make_feature


function N7timerWeatherSDK.new(options)
  local self = setmetatable({}, N7timerWeatherSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function N7timerWeatherSDK:options_map()
...
function N7timerWeatherSDK:get_utility()
  return Utility.copy(self._utility)
end


function N7timerWeatherSDK:get_root_ctx()
  return self._rootctx
end


function N7timerWeatherSDK:prepare(fetchargs)
...
function N7timerWeatherSDK:direct(fetchargs)
...
-- by passing it.
function N7timerWeatherSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function N7timerWeatherSDK:graphql(query, variables, ctrl)
  ...
  if type(errors) == "table" and 0 < #errors then
    ...
    res.ok = false
    res.err = "N7timerWeatherSDK: graphql: " .. msg
    res.graphql = errors
  end
...
function N7timerWeatherSDK:Apipl(data)
  ...
  if data == nil then
    if self._apipl == nil then
      self._apipl = EntityMod.new(self, nil)
    end
    return self._apipl
  end
...
function N7timerWeatherSDK:GraphicalApi(data)
  ...
  if data == nil then
    if self._graphical_api == nil then
      self._graphical_api = EntityMod.new(self, nil)
    end
...
function N7timerWeatherSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = N7timerWeatherSDK.new(sdkopts)
  sdk.mode = "test"
