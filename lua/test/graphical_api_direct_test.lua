...
describe("GraphicalApiDirect", function()
  it("should direct-load-graphical_api", function()
    local setup = graphical_api_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-graphical_api", setup.live and "live" or "unit")
...
function graphical_api_direct_setup(mockres)
