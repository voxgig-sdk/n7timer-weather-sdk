...
function runner.env_override(m)
  local live = runner.getenv("N7TIMERWEATHER_TEST_LIVE")
  local override = runner.getenv("N7TIMERWEATHER_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("N7TIMERWEATHER_TEST_EXPLAIN")
