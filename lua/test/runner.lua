...
function runner.env_override(m)
  local live = runner.getenv("N7TIMER_WEATHER_TEST_LIVE")
  local override = runner.getenv("N7TIMER_WEATHER_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("N7TIMER_WEATHER_TEST_EXPLAIN")
