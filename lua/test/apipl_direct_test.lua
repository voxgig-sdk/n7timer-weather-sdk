...
describe("ApiplDirect", function()
  it("should direct-list-apipl", function()
    local setup = apipl_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-apipl", setup.live and "live" or "unit")
...
function apipl_direct_setup(mockres)
