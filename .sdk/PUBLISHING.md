...
|---|---|---|
| `ts/` | @voxgig-sdk/n7timer-weather-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/n7timer-weather-sdk \
      --repository voxgig-sdk/n7timer-weather-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/n7timer-weather-sdk` shows it, and
`npm trust revoke @voxgig-sdk/n7timer-weather-sdk --id=<id>` removes it.
