...
// N7timerWeather SDK utility: make_options

class N7timerWeatherMakeOptions
{
    ...
    public static function call(N7timerWeatherContext $ctx): array
    {
        ...
        //
        // `N7timerWeatherSchema::optspec()` is built from the model:
        ...
        $optspec = N7timerWeatherSchema::optspec();
