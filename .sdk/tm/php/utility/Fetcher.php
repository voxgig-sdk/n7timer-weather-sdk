...
// N7timerWeather SDK utility: fetcher

class N7timerWeatherFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; N7timerWeatherSDK/1.0)';
    ...
    public static function call(N7timerWeatherContext $ctx, string $fullurl, array $fetchdef): array
    {
