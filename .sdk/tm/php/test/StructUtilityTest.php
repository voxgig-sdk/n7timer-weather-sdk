...
// N7timerWeather SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = N7timerWeatherOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(N7timerWeatherOmni::structfix($now, Struct::undef()))
                        !== json_encode(N7timerWeatherOmni::structfix($val, Struct::undef()))) {
