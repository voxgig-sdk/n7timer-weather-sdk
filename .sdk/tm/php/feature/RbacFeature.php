...
// N7timerWeather SDK rbac feature
...
class N7timerWeatherRbacFeature extends N7timerWeatherBaseFeature
{
    ...
    private function _required(N7timerWeatherContext $ctx): ?string
    {
    ...
    private function _reject(N7timerWeatherContext $ctx, string $required): void
    {
    ...
    private function _track(N7timerWeatherContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
