...
// N7timerWeather SDK clienttrack feature
...
class N7timerWeatherClienttrackFeature extends N7timerWeatherBaseFeature
{
    ...
    public function PostConstruct(N7timerWeatherContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'N7timerWeather-SDK';
