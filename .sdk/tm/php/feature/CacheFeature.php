...
// N7timerWeather SDK cache feature
...
class N7timerWeatherCacheFeature extends N7timerWeatherBaseFeature
{
    ...
    private function _through(N7timerWeatherContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
