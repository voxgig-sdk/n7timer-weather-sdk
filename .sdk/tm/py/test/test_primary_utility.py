...
from projectname_sdk import N7timerWeatherSDK
from projectname_sdk.core.spec import N7timerWeatherSpec
from projectname_sdk.core.result import N7timerWeatherResult
from projectname_sdk.core.response import N7timerWeatherResponse
from projectname_sdk.core.operation import N7timerWeatherOperation
from projectname_sdk.core.error import N7timerWeatherError
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import N7timerWeatherBaseFeature
...
def _err_from_map(m):
    ...
    if msg == "":
        return None
    code = m.get("code", "")
    return N7timerWeatherError(code, msg)
...
class TestPrimaryUtility:
    ...
    def test_done_basic(self):
        ...
        def subject(entry):
            ...
            except N7timerWeatherError as e:
                return None, e
    ...
    def test_make_error_no_throw(self):
        ...
        ctx.result = N7timerWeatherResult({
            "ok": False,
            "resdata": {"id": "safe01"},
        })
    ...
    def test_feature_init_basic(self):
        init_client = N7timerWeatherSDK.test(None, None)
        ...
        class TestInitFeature(N7timerWeatherBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(N7timerWeatherBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_fetcher_blocked_test_mode(self):
        ...
        blocked_client = N7timerWeatherSDK({
            "base": "http://localhost:8080",
            "system": {
                "fetch": mock_fetch,
            },
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = N7timerWeatherSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = N7timerWeatherSDK.test(None, setup_opts)
    ...
    def test_operator_basic(self):
        ...
        def subject(entry):
            ...
            if not isinstance(in_val, dict):
                in_val = {}
            op = N7timerWeatherOperation(in_val)
            return {
                "entity": op.entity,
                "name": op.name,
                "input": op.input,
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = N7timerWeatherSDK.test(None, setup_opts)
