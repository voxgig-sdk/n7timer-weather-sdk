...
class N7timerWeatherTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = N7timerWeatherTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = N7timerWeatherTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = N7timerWeatherTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
