...
from projectname_sdk.core.control import N7timerWeatherControl
...
class N7timerWeatherContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = N7timerWeatherControl()
        ...
        if isinstance(sp, N7timerWeatherSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, N7timerWeatherResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, N7timerWeatherResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return N7timerWeatherOperation({})
    ...
    def make_error(self, code, msg):
        return N7timerWeatherError(code, msg, self)
