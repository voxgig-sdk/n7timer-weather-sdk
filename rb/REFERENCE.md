# N7timerWeather Ruby SDK Reference

Complete API reference for the N7timerWeather Ruby SDK.
...
#### `N7timerWeatherSDK.test(testopts = nil, sdkopts = nil)`
...
```ruby
result = client.GraphicalApi.load({ "lat" => 1, "lon" => 1 })
```
