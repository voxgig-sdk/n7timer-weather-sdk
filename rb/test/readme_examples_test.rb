...
#      offline in seeded test mode (N7timerWeatherSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "N7timerWeather_sdk.rb")
  SDK_CLASS = "N7timerWeatherSDK"
