...
class GraphicalApiEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set N_TIMERWEATHER_TEST_GRAPHICAL_API_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def graphical_api_basic_setup(extra)
  ...
  entid_env_raw = ENV["N_TIMERWEATHER_TEST_GRAPHICAL_API_ENTID"]
