// Command N7timerWeather-mcp is an MCP server exposing the N7timerWeather
// SDK as MCP tools.
//
// Two tools are registered:
//
//	N7timerWeather_list  — list records of an entity
//	N7timerWeather_load  — load a single record of an entity
//
