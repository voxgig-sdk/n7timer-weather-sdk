...
type Args struct {
	Entity string         `json:"entity" jsonschema:"apipl | graphical_api"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.N7timerWeatherSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "n7timer-weather_list",
		Description: "List records from N7timerWeather. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "n7timer-weather_load",
		Description: "Load a single record from N7timerWeather. " +
...
func runOp(client *sdk.N7timerWeatherSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.N7timerWeatherSDK, name string) (sdk.N7timerWeatherEntity, error) {
	switch strings.ToLower(name) {
	case "apipl":
		return client.Apipl(nil), nil
	case "graphical_api":
		return client.GraphicalApi(nil), nil
