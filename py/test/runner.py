...
class N7timerWeatherTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = N7timerWeatherTestRunner.getenv("N7TIMERWEATHER_TEST_LIVE")
        override = N7timerWeatherTestRunner.getenv("N7TIMERWEATHER_TEST_OVERRIDE")
        ...
        explain = N7timerWeatherTestRunner.getenv("N7TIMERWEATHER_TEST_EXPLAIN")
