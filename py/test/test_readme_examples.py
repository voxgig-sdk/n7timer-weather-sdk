# N7timerWeather SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions N7timerWeatherSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both N7timerWeatherSDK(...) and N7timerWeatherSDK.test(...) become
#      N7timerWeatherSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "n7timerweather_sdk"
_SDK_CLASS = "N7timerWeatherSDK"
