...
class ApiplEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ApiplEntity(self._client, opts)
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[Apipl]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.Apipl().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
