...
from n7timerweather_sdk.utility import register

# Load features
from n7timerweather_sdk.feature.base_feature import N7timerWeatherBaseFeature
from n7timerweather_sdk.features import _has_feature, _make_feature
...
class N7timerWeatherSDK:
    ...
    def get_utility(self):
        return N7timerWeatherUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("N7timerWeatherSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Apipl(self, data=None) -> "ApiplEntity":
        ...
        from n7timerweather_sdk.entity.apipl_entity import ApiplEntity
    ...
    def GraphicalApi(self, data=None) -> "GraphicalApiEntity":
        ...
        from n7timerweather_sdk.entity.graphical_api_entity import GraphicalApiEntity
