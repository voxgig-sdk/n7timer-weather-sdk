...
Results: Weather forecast data in the requested format.
...
Results: PNG image containing the weather forecast diagram.
...
| --- | --- | --- | --- |
| Apipl | `list` | `GET /bin/api.pl` | See reference |
| GraphicalApi | `load` | `GET /bin/astro.php` | See reference |

## Connect to the API

- 7Timer Production Server: `http://www.7timer.info`
...
- `n7timer-weather_list`: List records for an entity. Supported entities: `apipl`.
- `n7timer-weather_load`: Load one record for an entity. Supported entities: `graphical_api`.
