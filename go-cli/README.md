...
AQL-driven CLI and REPL for the N7timerWeather SDK. Positional arguments are
...
```sh
go build -o n7timer-weather-cli ./...
```
...
./n7timer-weather-cli load 1 apipl
./n7timer-weather-cli load '{id:1}' apipl
