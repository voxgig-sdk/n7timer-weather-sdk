...
func registerSDKWords(r *eng.Registry, client *sdk.N7timerWeatherSDK) {
...
func runOp(client *sdk.N7timerWeatherSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
